...
namespace WEBMI\Bundle\Text2ImageBundle\Parser;

use WEBMI\Bundle\Text2ImageBundle\Text2ImageParserInterface;

if(!class_exists('\Text2ImageExtraParser')) {
    require_once(realpath(__DIR__.'/..').'/vendor/parser/Text2ImageExtraParser.php');
}
 ...
 */
class Text2ImageParser extends \Text2ImageExtraParser implements Text2ImageParserInterface
{
    ...
    /**
     * Text2ImageExtraParser overwritten methods
     */
