...
require_once(dirname(__FILE__).'/Text2ImageParser.php');

/**
 * Text2ImageExtraParser parser provides extra markdown syntax as described here http://michelf.com/projects/php-markdown/extra/
 */
class Text2ImageExtraParser extends Text2ImageParser
{
    ...
    protected function hashHTMLBlocks($text)
    {
        ...
        #
        list($text, ) = $this->_hashHTMLBlocks_inText2Image($text);

        return $text;
    }

    protected function _hashHTMLBlocks_inText2Image($text, $indent = 0, $enclosing_tag_re = '', $span = false)
    {
        #
    ...
    protected function _hashHTMLBlocks_inHTML($text, $hash_method, $md_attr)
    {
        ...
        do
        {
            ...
            else
            {
                ...
                #
                if ($md_attr &&
                preg_match($text2image_attr_re, $tag, $attr_m) &&
                preg_match('/^1|block|span$/', $attr_m[2].$attr_m[3]))
                {
                    # Remove `markdown` attribute from opening tag.
                    $tag = preg_replace($text2image_attr_re, '', $tag);
                    ...
                    list ($block_text, $text)
                    = $this->_hashHTMLBlocks_inText2Image($text, $indent,
